...
var SHELL_FILES = [
  ...
  "./home.html", "./stores.js", "./store.html", "./reels.html", "./gallery.html", "./gifuyatenjin.html", "./gifuya_reels.html", "./nagagutsu.html", "./nagagutsu_reels.html", "./goldporta.html", "./goldporta_reels.html", "./karasuma.html", "./karasuma_reels.html",
  "./config.gifuya.js", "./config.nagagutsu.js", "./config.goldporta.js", "./config.karasuma.js",
...
self.addEventListener("fetch", function (e) {
  ...
  if (url.origin === self.location.origin && /\/(home\.html|stores\.js|store\.html|reels\.html|gallery\.html|gifuyatenjin\.html|gifuya_reels\.html|nagagutsu\.html|nagagutsu_reels\.html|goldporta\.html|goldporta_reels\.html|karasuma\.html|karasuma_reels\.html|app\.js|config\.js|config\.gifuya\.js|config\.nagagutsu\.js|config\.goldporta\.js|config\.karasuma\.js)$/.test(url.pathname)) {
