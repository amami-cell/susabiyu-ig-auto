...
self.addEventListener("fetch", function (e) {
  ...
  if (url.origin === self.location.origin && /\/(home\.html|stores\.js|store\.html|reels\.html|gallery\.html|gifuyatenjin\.html|gifuya_reels\.html|nagagutsu\.html|nagagutsu_reels\.html|nagagutsu_lp\.html|goldporta\.html|goldporta_reels\.html|goldporta_lp\.html|gold\.html|app\.js|config\.js|config\.gifuya\.js|config\.nagagutsu\.js|config\.goldporta\.js)$/.test(url.pathname)) {
