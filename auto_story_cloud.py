...
TELOPS={"FOOD":["旬の魚、入ってます。","お造り、切りたてです。","本日のおすすめ。","寿司、握りたてです。"],"SAKE":["仕事のあとの一杯に。","今宵もお待ちしてます。","二軒目にどうぞ。","日本酒、入荷しました。"],"INTERIOR":["京都三条の寿司酒場。","まだお席ございます。","カウンターで一杯。"],"EVENT":["ご宴会承ります。","貯切もご相談ください。"]}
def get_services():
...
def main():
    ...
    record(sheets,photo,genre);url=up(out);post(url)
    print("=== DONE ===")
