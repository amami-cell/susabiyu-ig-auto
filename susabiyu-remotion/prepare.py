...
APP_TAB = "承認待ち"
PAT_JA = {"sushi":"王道","tempo":"賑やか","typo":"雑誌風","photo":"全画面","simple":"額装","caption":"写真キャプション", "oshina":"お品書き","oshinatate":"お品書き(縦書き)","kaiten":"回転レーン","osusume":"店主おすすめ","gridzoom":"グリッド→ズーム","aburi":"炙り","noren":"暖簾くぐり","season":"季節の旬"}
REG = {
  ...
  "aburi":   ("fetch_kaiten.py","AburiStory",True),
