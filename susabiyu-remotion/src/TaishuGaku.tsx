...
import { simplePhoto, simplePhrase, simpleBg, simpleSeed } from "./simpleData";
import { NorenImgBase } from "./TaishuNorenImg";
import { pickFuda } from "./taishu";
...
export const TaishuGaku: React.FC<{ storeName?: string; handle?: string }> = ({
  ...
  const tag = pickFuda("food", simpleSeed, simplePhrase);
