...
export type YTheme = { base: string; ink: string; sub: string; line: string; accent: string; slab: string; label: string; footBase: string };
// slab = 大面積のベタ塗り用の少し深いテラコッタ（accentをそのまま面で使うとオレンジが強く安っぽく浮くため）。

export const YTHEMES: Record<string, YTheme> = {
  // フレンチ＝GOLD：黒×金×生成り
  french:  { base: "#0c0c0e", ink: "#F5F0E6", sub: "#CBB98F", line: "#C9A24B", accent: "#E7C873", slab: "#A8801F", label: "BISTRO FRANÇAIS", footBase: "#0a0a0c" },
