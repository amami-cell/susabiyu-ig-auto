...
def reqcols(target=None):
    ...
    headers = [
        ...
        "キャッチコピー（任意・見出し用）",
        "定番ハッシュタグ（任意・カンマ区切り）",
        "IG数値ユーザーID（分かればでOK・空欄可＝トークンから自動取得）",
        "定休日",
        "コース・メニュー詳細（コースがあればLPに載せます／食べログ等のURLでも可）",
    ]
    sp.values().update(spreadsheetId=sid, range="'%s'!K%d:AA%d" % (tab, HEAD_ROW, HEAD_ROW),
    ...
    examples = {
        6: ["すさび湯三条", "寿司・大衆酒場", "京都・河原町三条", "", "", "", "050-5597-3661", "", "",
            ...
            "", "https://tabelog.com/kyoto/A2601/A260202/26043883/"],
        14: ["ナガグツ", "イタリアン・肉バル", "", "", "", "", "", "", "", "", "", "", "", "", "", "", ""],
    ...
    try:
        reqs = [
            ...
            {"updateDimensionProperties": {"range": {"sheetId": gid, "dimension": "COLUMNS",
                "startIndex": 10, "endIndex": 27}, "properties": {"pixelSize": 230}, "fields": "pixelSize"}},
